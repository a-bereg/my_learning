...
table_cost_1 = table_item[0]['quantity'] * table_item[0]['price']
table_cost_2 = table_item[1]['quantity'] * table_item[1]['price']
...
sofa_cost_1 = sofa_item[0]['quantity'] * sofa_item[0]['price']
sofa_cost_2 = sofa_item[1]['quantity'] * sofa_item[1]['price']
...
chair_cost_1 = chair_item[0]['quantity'] * chair_item[0]['price']
chair_cost_2 = chair_item[1]['quantity'] * chair_item[1]['price']
chair_cost_3 = chair_item[2]['quantity'] * chair_item[2]['price']
